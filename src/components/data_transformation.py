...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info(f"Training dataframe columns: {list(input_feature_train_df.columns)}")
            ...
            logging.info(f"Transformed training data shape: {input_feature_train_arr.shape}")
